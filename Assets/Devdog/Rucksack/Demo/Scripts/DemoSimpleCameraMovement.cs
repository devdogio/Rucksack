...
{
    public class DemoSimpleCameraMovement : MonoBehaviour
    {
        [Header("References")]
...
//            else if (Mathf.Approximately(target.forward.magnitude, 0f) == false && Mathf.Approximately(target.forward, 0f) == false && _rotateBehind)
//            {
//                RotateBehindTarget();
//            }
