...
{
    public class PUN2ItemInstance : UnityItemInstance, INetworkItemInstance
    {
        // Used for (de) serialization
        protected PUN2ItemInstance()
        { }

        protected PUN2ItemInstance(Guid ID, IUnityItemDefinition itemDefinition)
