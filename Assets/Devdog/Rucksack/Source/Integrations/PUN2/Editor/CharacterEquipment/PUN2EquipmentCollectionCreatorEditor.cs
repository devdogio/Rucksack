...
namespace Devdog.Rucksack.Collections
{
    ...
    /// </summary>
    [CustomEditor(typeof(PUN2EquipmentCollectionCreator))]
    public sealed class PUN2EquipmentCollectionCreatorEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var t = (PUN2EquipmentCollectionCreator)target;
            var bridge = t.GetComponent<PUN2ActionsBridge>();
