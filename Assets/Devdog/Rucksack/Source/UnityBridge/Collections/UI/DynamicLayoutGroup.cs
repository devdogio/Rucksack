...
namespace Devdog.Rucksack.UI
{
    ...
    public class DynamicLayoutGroup : LayoutGroup
    {
        ...
        [SerializeField]
        protected int m_ColumnCount = 5;
        public int columnCount { get { return m_ColumnCount; } set { SetProperty(ref m_ColumnCount, Mathf.Max(1, value)); } }
...
//        }
        ...
        public override void CalculateLayoutInputHorizontal()
        {
            ...
            minColumns = preferredColumns = m_ColumnCount;
        ...
        public override void CalculateLayoutInputVertical()
        {
            ...
            int minRows = Mathf.CeilToInt(rectChildren.Count / (float)m_ColumnCount - 0.001f);
